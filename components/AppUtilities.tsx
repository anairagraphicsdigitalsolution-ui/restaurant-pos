  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        @media(max-width:900px){.app-header{grid-template-columns:minmax(0,1fr) auto}.header-context{display:none}}@media(max-width:767px){.app-header{padding-left:66px;padding-right:10px;padding-top:max(9px,env(safe-area-inset-top));min-height:calc(62px + env(safe-area-inset-top));scroll-margin-top:env(safe-area-inset-top)}.header-search{min-width:0}.mobile-menu-button{z-index:9500!important}.app-header{z-index:9000}}@media(max-width:520px){.notification-menu{right:-6px;width:min(300px,calc(100vw - 20px))}.app-header{min-height:calc(58px + env(safe-area-inset-top));padding-left:64px;padding-right:8px;gap:7px}.header-search{height:40px}.header-search-placeholder{font-size:11px}.header-search kbd{display:none}.header-notification{width:40px;height:40px}.order-toast{right:10px;top:calc(70px + env(safe-area-inset-top))}.search-overlay{padding:calc(4vh + env(safe-area-inset-top)) 10px max(10px,env(safe-area-inset-bottom))}.search-modal{border-radius:18px;max-height:calc(86dvh - env(safe-area-inset-top) - env(safe-area-inset-bottom))}}
      `}</style>
    </>
  )
}
