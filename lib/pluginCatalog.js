...
export const PLUGIN_CATALOG = [
  {code:"operations-hub",name:"Operations Hub",icon:"🧭",category:"Core",description:"Restaurant operations center for loyalty, offers, notifications and operational workflows."},
  ...
  {code:"offers",name:"Offers & Promotions",icon:"🎁",category:"Marketing",description:"Offers and combos with monthly plan limits."},
