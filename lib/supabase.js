...
import { shouldUseOfflineLocal, createOfflineFrom } from "@/lib/mobileSupabaseOffline"
import {
...
export const supabase = new Proxy(
  supabaseCloud,
  {
    get(target, property, receiver) {
      ...
      if (property === "from") {
        return (...args) => shouldUseOfflineLocal() ? createOfflineFrom(args[0]) : getDataClient().from(...args)
      }
