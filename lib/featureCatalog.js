export const FEATURE_CATALOG = [
  ...
  { code: "offers", name: "Offers & Combos", icon: "🎁", category: "Marketing", description: "Offers, coupons and combo meals controlled by the Offers & Combos plugin." },
  ...
  { code: "p2-call-center", name: "P2 Call Center", icon: "📞", category: "P2 Advanced Operations", description: "Call Center workflow." },
  { code: "p2-banquet-events", name: "P2 Banquet / Events / Catering", icon: "🎪", category: "P2 Advanced Operations", description: "Banquet and catering workflow." },
  { code: "p2-advanced-kiosk", name: "P2 Advanced Kiosk", icon: "🖥️", category: "P2 Advanced Operations", description: "Advanced self-order kiosk workflow." },
  { code: "p2-customer-display", name: "P2 Customer Display", icon: "📺", category: "P2 Advanced Operations", description: "Dual-screen customer display workflow." },
  { code: "p2-device-hq", name: "P2 Device HQ", icon: "🧰", category: "P2 Advanced Operations", description: "Central device management workflow." },
  { code: "p2-ai-intelligence", name: "P2 AI Decision Intelligence", icon: "🧠", category: "P2 Advanced Operations", description: "AI decision intelligence workflow." },
