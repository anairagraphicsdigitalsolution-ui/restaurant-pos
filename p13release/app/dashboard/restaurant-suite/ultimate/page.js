...
const styles = `.ultimate{min-height:100vh;padding:24px;max-width:1500px;margin:auto;background:var(--background,var(--background));color:var(--text,#f4efe5)}.hero{display:flex;justify-content:space-between;gap:20px;align-items:flex-start;padding:28px;border:1px solid var(--border,rgba(255,255,255,.12));border-radius:24px;background:var(--surface,var(--surface-2))}.hero small{color:var(--primary,#e3ad39);font-weight:800;letter-spacing:.18em}.hero h1{margin:8px 0;font-size:clamp(28px,4vw,48px)}.hero p,.info p,.row span,.metric small{color:var(--muted,var(--muted))}button{border:1px solid var(--border,rgba(255,255,255,.12));border-radius:11px;padding:10px 14px;background:var(--surface-2,#123025);color:var(--text,#f4efe5);font-weight:700;cursor:pointer}.hero button:hover,.tabs .active{background:var(--primary,#e3ad39);color:#111}.metrics{display:grid;grid-template-columns:repeat(5,1fr);gap:14px;margin:18px 0}.metric,.panel,.info,.table{border:1px solid var(--border,rgba(255,255,255,.12));background:var(--surface,var(--surface-2));border-radius:18px}.metric{padding:18px}.metric span{font-size:24px;display:block}.metric small,.metric strong{display:block;margin-top:7px}.metric strong{font-size:25px}.tabs{display:flex;gap:8px;overflow:auto;padding:4px 0 16px}.tabs button{white-space:nowrap}.msg{padding:12px;margin-bottom:14px;border-radius:12px;border:1px solid rgba(227,173,57,.35)}.panel{padding:20px;margin-bottom:20px}.panel h2{margin-top:0}.info-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:18px}.info{padding:16px}.info p{margin-bottom:0;line-height:1.5}.list{display:flex;flex-direction:column}.row{display:flex;justify-content:space-between;gap:15px;padding:13px 0;border-top:1px solid rgba(255,255,255,.07)}.table-grid{display:grid;grid-template-columns:repeat(5,1fr);gap:12px}.table{padding:16px;display:flex;flex-direction:column;gap:8px}.table span{color:var(--muted,var(--muted));font-size:13px}.table em{text-transform:capitalize;color:var(--primary,#e3ad39);font-style:normal}.loading{min-height:80vh;display:grid;place-items:center;color:var(--muted,var(--muted))}@media(max-width:1000px){.metrics{grid-template-columns:repeat(3,1fr)}.info-grid{grid-template-columns:repeat(2,1fr)}.table-grid{grid-template-columns:repeat(3,1fr)}}@media(max-width:650px){.ultimate{padding:14px}.hero{flex-direction:column}.metrics,.info-grid,.table-grid{grid-template-columns:1fr}.panel{padding:15px}.row{flex-direction:column;align-items:flex-start}}`
