-- Offer usage / billing preview alignment.
-- Usage limits count completed paid bills, not the order currently being billed.
-- This keeps QR/web offers consistent with the terminal billing finalize RPC.
-- Non-destructive: no orders or payments are deleted or rewritten.
