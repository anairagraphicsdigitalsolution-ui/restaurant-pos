-- Theme assignment + Admin permission enforcement.
-- Super Admin decides whether Admin may change the restaurant theme, QR theme,
-- or both. "none" is the safe default for existing/new restaurants.
...
SET config =
  jsonb_set(
    ...
    '{allow_admin_operational_settings}',
    'false'::jsonb,
    true
  )
WHERE plugin_code = 'restaurant-settings';

-- Also seed future rows with the same safe policy.
