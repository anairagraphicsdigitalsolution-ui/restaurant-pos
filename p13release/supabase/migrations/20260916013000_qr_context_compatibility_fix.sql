-- QR context compatibility fix: preserve the previously working QR lookup
-- semantics. QR menu context must resolve an existing restaurant by slug;
-- plugin/plan checks remain authoritative outside this lookup.
BEGIN;
