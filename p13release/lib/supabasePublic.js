...
// Public QR realtime deliberately uses an isolated client. It must never share
// the restaurant staff Auth session/localStorage lock with the main app.
export const supabasePublic = createClient(url, anonKey, {
  global: { fetch: supabaseFetch },
  auth: { autoRefreshToken: false, persistSession: false, detectSessionInUrl: false },
})
export const supabasePublicRuntimeMode = "cloud"
