...
const qrBox={margin:"12px auto",width:190,height:190,display:"grid",placeItems:"center",background:"#fff",borderRadius:15}
...
const primaryBtn={flex:1,padding:"9px 8px",borderRadius:10,border:0,background:"var(--primary)",color:"#fff",fontWeight:900,cursor:"pointer"}
