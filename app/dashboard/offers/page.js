...
export default function OffersPage() {
  ...
  async function getRestaurant() {
    ...
    if (profileError || !profile?.restaurant_id) {
      console.error(
        profileError || new Error("Restaurant profile not found")
      )
      setLoading(false)
      return
    }
  ...
  async function fetchUsage() {
    ...
    if (error) {
      console.error("Offer usage", error)
      return
    }
    ...
    ;(data || []).forEach((o) => {
      ...
      x.uses++
      x.revenue += Number(o.total_amount || 0)
      x.saved += Number(o.discount_amount || 0)
  ...
  function toggleProduct(id) {
    setForm((p) => ({
      ...p,
      product_ids: p.product_ids.includes(id)
  ...
  async function saveOffer() {
    if (
      ...
      alert("Title, discount and valid-till date are required")
      return
    }
    ...
    if (
      ["bogo", "buy_get"].includes(form.offer_type) &&
      (!form.buy_quantity || !form.get_quantity)
    ) {
      alert("Buy and Get quantities are required")
      return
    }
    ...
    try {
      const payload = {
        ...
        customer_tier:
          form.customer_tier.trim() || null,

        new_customer_only:
          !!form.new_customer_only,

        buy_quantity:
          Math.max(
            1,
            Number(form.buy_quantity || 1)
          ),

        get_quantity:
          Math.max(
            1,
            Number(form.get_quantity || 1)
          ),
  ...
  const filteredOffers = useMemo(
    () =>
      offers.filter((o) => {
        ...
        const t = o.valid_till
          ? new Date(
              `${o.valid_till}T23:59:59`
            )
          : null

        const f = o.valid_from
          ? new Date(
              `${o.valid_from}T00:00:00`
            )
          : null
        ...
        if (filter === "product") {
          return o.target_type === "products"
        }

        if (filter === "coupon") {
          return !!o.coupon_code
        }
  ...
  const stats = {
    ...
    product: offers.filter(
      (o) => o.target_type === "products"
    ).length,

    coupon: offers.filter(
      (o) => o.coupon_code
    ).length,
  ...
  return (
    ...
    >
      ...
      <style jsx global>{`
        ...
        .offersTabs button.active {
          background: rgba(var(--primary-rgb),.14);
          color: var(--primary);
          box-shadow: 0 8px 25px rgba(0,0,0,.18);
        }

        .offersTabs + .combo-page {
          margin: -18px -40px -50px;
          padding: 0 40px 50px;
        }

        .offers-page .offers-smart-hero {
          width: 100%;
          box-sizing: border-box;
        }

        .offers-page .offers-smart-badge {
          min-width: 0;
          box-sizing: border-box;
        }
        ...
        @media(max-width:900px) {
          ...
          .offers-page {
            padding: 78px 18px 35px !important;
          }

          .offers-page .hero,
          .offers-page .sectionHead,
          .offers-page .pickerTop {
        ...
        @media(max-width:768px) {
          ...
          .offers-page .offers-smart-hero > div:first-child {
            width: 100% !important;
            min-width: 0 !important;
          }

          .offers-page .offers-smart-hero h1 {
            font-size: clamp(32px,10vw,44px) !important;
            line-height: 1.02 !important;
            overflow-wrap: anywhere !important;
          }

          .offers-page .offers-smart-hero p {
          ...
          .offers-page .offers-smart-badge > div {
            min-width: 0 !important;
            flex: 1 1 auto !important;
          }

          .offers-page .offers-smart-badge b {
            display: block !important;
          ...
          .offers-page .offers-smart-badge small {
            display: block !important;
            white-space: normal !important;
            overflow-wrap: anywhere !important;
        ...
        @media(max-width:700px) {
          ...
          .offers-page .heroBadge b {
            font-size: 13px !important;
          }

          .offers-page .heroBadge small {
            display: block !important;
          ...
          .offers-page .statCard strong {
            font-size: 18px !important;
          }

          .offers-page .statCard span {
          ...
          .offers-page .productGrid {
            grid-template-columns: 1fr !important;
          }

          .offers-page .formFooter {
            align-items: stretch !important;
            flex-direction: column !important;
          }
          ...
          .offers-page .actions button:last-child {
            grid-column: 1 / -1;
          }
        }
        ...
        <>
          ...
          >
            <div>
              ...
              <p style={subtitle}>
                Product targeting, coupons, BOGO,
                free items, scheduling, loyalty
                eligibility and offer analytics —
                all in one place.
              </p>
            </div>

            <div
              className="offers-smart-badge"
              style={heroBadge}
            >
              ...
              <div>
                <b>Smart Promotions</b>
                <small>
                  Auto-select the best eligible offer
                </small>
              </div>
            </div>
          </section>
          ...
          <div style={toolbar}>
            <input
              placeholder="Search title, coupon..."
              value={search}
              onChange={(e) =>
          ...
          <section style={formBox}>
            <div style={sectionHead}>
              <div>
                ...
                <p style={muted}>
                  Build a promotion with precise
            ...
            <div style={formGrid}>
              ...
              <Field label="Description">
                <input
                  ...
                  onChange={handleChange}
                  placeholder="20% off selected dishes"
                  style={input}
                />
              </Field>
...
function OfferCard({
  ...
  const t = offer.valid_till
    ? new Date(
        `${offer.valid_till}T23:59:59`
      )
    : null
  ...
  const discount =
    offer.offer_type === "free_item"
      ? "FREE"
      : ["bogo", "buy_get"].includes(
            offer.offer_type
          )
        ? `${offer.buy_quantity || 1}+${offer.get_quantity || 1}`
  ...
  return (
    <article style={card}>
      <div style={cardTop}>
        ...
        {offer.featured && (
          <span style={featuredPill}>
            ⭐ FEATURED
          </span>
        )}
      </div>

      <div style={discountCircle}>
...
const saveBtn = {
  ...
  background:
    "linear-gradient(135deg,var(--primary),rgba(var(--primary-rgb),.65))",
  color: "#111",
  fontWeight: 900,
  cursor: "pointer"
}
...
const discountCircle = {
  ...
  alignContent: "center",
  background:
    "radial-gradient(circle,rgba(var(--primary-rgb),.35),rgba(var(--primary-rgb),.07))",
  border:
    "1px solid rgba(var(--primary-rgb),.35)"
}
