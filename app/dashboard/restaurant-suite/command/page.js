...
export default function RestaurantCommandCenter() {
  ...
  return <main className="cmd-page">
    ...
    <style jsx global>{`
      .cmd-page{min-height:100vh;padding:24px;max-width:1500px;margin:0 auto;color:var(--text,var(--text));background:var(--background,var(--background))}
      .cmd-hero{display:flex;justify-content:space-between;gap:20px;align-items:flex-start;padding:28px;border:1px solid var(--border,rgba(255,255,255,.12));border-radius:24px;background:var(--surface,var(--surface))}
      .cmd-hero small{color:var(--primary,var(--primary));font-weight:800;letter-spacing:.18em}.cmd-hero h1{margin:8px 0;font:800 clamp(28px,4vw,48px)/1.05 Georgia,serif}.cmd-hero p,.cmd-note{color:var(--muted,var(--muted))}.cmd-hero button,.cmd-tabs button,.cmd-card button,.cmd-form button{border:1px solid var(--border,rgba(255,255,255,.12));border-radius:11px;padding:10px 14px;background:var(--surface-2,var(--surface-2));color:var(--text,var(--text));font-weight:700;cursor:pointer}.cmd-hero button:hover,.cmd-tabs button.active,.cmd-card button:hover,.cmd-form button:hover{background:var(--primary,var(--primary));color:#111}.cmd-tabs{display:flex;gap:8px;overflow:auto;padding:16px 0}.cmd-tabs button{white-space:nowrap}.cmd-stats{display:grid;grid-template-columns:repeat(4,1fr);gap:14px;margin-bottom:18px}.cmd-stat,.cmd-card{border:1px solid var(--border,rgba(255,255,255,.12));border-radius:20px;background:var(--surface,var(--surface))}.cmd-stat{padding:18px}.cmd-icon{font-size:22px;margin-bottom:10px}.cmd-stat span,.cmd-stat small{display:block;color:var(--muted,var(--muted))}.cmd-stat strong{display:block;font-size:28px;margin:3px 0}.cmd-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:18px}.cmd-card{padding:20px}.cmd-card header{display:flex;justify-content:space-between;align-items:center;gap:12px;margin-bottom:14px}.cmd-card h2{margin:0;font-size:21px}.cmd-list{display:flex;flex-direction:column}.cmd-row{display:flex;justify-content:space-between;gap:15px;padding:12px 0;border-top:1px solid rgba(255,255,255,.07)}.cmd-row span{color:var(--muted,var(--muted))}.cmd-links{display:flex;gap:10px;flex-wrap:wrap}.cmd-links a{color:var(--primary,var(--primary));text-decoration:none;padding:10px;border:1px solid var(--border,rgba(255,255,255,.12));border-radius:10px}.floor-map{position:relative;min-height:520px;overflow:auto;border:1px dashed var(--border,rgba(255,255,255,.15));border-radius:18px;background:repeating-linear-gradient(0deg,rgba(255,255,255,.025) 0,rgba(255,255,255,.025) 1px,transparent 1px,transparent 40px),repeating-linear-gradient(90deg,rgba(255,255,255,.025) 0,rgba(255,255,255,.025) 1px,transparent 1px,transparent 40px)}.floor-table{position:absolute;width:120px;min-height:92px;padding:10px;border:1px solid var(--primary,var(--primary));border-radius:14px;background:#112c21;box-shadow:0 8px 20px rgba(0,0,0,.2)}.floor-table.occupied{border-color:#e15b52}.floor-table.reserved{border-color:var(--primary)}.floor-table small{display:block;color:var(--muted,var(--muted));margin:4px 0}.floor-table button{padding:4px 7px!important;margin-right:3px;font-size:11px}.cmd-form{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.cmd-form input,.cmd-form select{width:100%;padding:11px;border-radius:10px;border:1px solid var(--border,rgba(255,255,255,.12));background:rgba(0,0,0,.14);color:var(--text,var(--text))}.cmd-form button{grid-column:1/-1}.cmd-table{display:grid}.cmd-head{display:grid;grid-template-columns:2fr 1fr 1fr 1fr;gap:10px;padding:12px;border-bottom:1px solid rgba(255,255,255,.08)}.cmd-head:not(:first-child){color:var(--muted,var(--muted))}.cmd-insight{color:var(--muted,var(--muted));line-height:1.7;margin:0}.cmd-loading{min-height:70vh;display:grid;place-items:center;color:var(--muted,var(--muted))}.cmd-toast{position:fixed;right:20px;bottom:20px;padding:14px 18px;border-radius:13px;border:1px solid rgba(231,174,57,.4);background:var(--surface-2);z-index:100}@media(max-width:900px){.cmd-stats,.cmd-grid{grid-template-columns:repeat(2,1fr)}.cmd-hero{flex-direction:column}}@media(max-width:620px){.cmd-page{padding:14px}.cmd-stats,.cmd-grid,.cmd-form{grid-template-columns:1fr}.cmd-head{grid-template-columns:1.5fr .7fr 1fr 1fr}.floor-map{min-height:430px}}
    `}</style>
  </main>
}
