...
export default function OrderPage() {
  ...
  if (error) return <div className="pos-error"><strong>{error}</strong><button type="button" onClick={handleBackToDashboard}>← Back to Dashboard</button></div>
  ...
  return (
    <div className="anaira-pos">
      ...
      {navigationOpen && (
        <div className="pos-navigation-drawer-layer" role="dialog" aria-modal="true" aria-label="POS navigation">
          <button
            type="button"
      ...
      <header className="pos-topbar">
        ...
        <button type="button" className="back-btn" onClick={handleBackToDashboard}>← <span>Back</span></button>
...
.pos-info-row{display:grid;max-height:52px;grid-template-columns:190px 1fr 180px 1.5fr;gap:8px;padding:9px 14px;background:var(--background);border-bottom:1px solid rgba(var(--primary-rgb),.12)}.info-cell{background:var(--surface);border:1px solid rgba(var(--primary-rgb),.14);border-radius:9px;padding:6px 9px;display:flex;align-items:center;gap:8px;min-width:0;box-shadow:0 3px 14px rgba(0,0,0,.12)}.info-cell label{font-size:8px;color:rgba(255,255,255,.52);font-weight:800;white-space:nowrap}.info-cell input,.info-cell select{border:0;outline:0;width:100%;font-size:11px;background:transparent;color:var(--text);min-width:0}.info-cell select option{background:var(--surface);color:var(--text)}.info-cell strong{font-size:11px;color:var(--primary)}
        ...
        @media(max-width:1100px){.pos-topbar{gap:8px;padding:0 10px}.pos-menu-btn{display:inline-flex;visibility:visible;opacity:1}.back-btn{min-height:42px;min-width:42px;padding:8px 10px}.brand-block{min-width:0;flex:1;overflow:hidden}.brand-block strong{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.top-actions{flex:0 0 auto}.top-actions .printer-btn,.top-actions>button:nth-child(2),.top-actions .live-pill{display:none}.pos-navigation-drawer-shell{width:min(86vw,360px)}}
        ...
        @media(max-width:520px){.pos-menu-btn{width:46px;height:44px;font-size:21px}.pos-menu-btn span{display:none}.back-btn{width:44px;height:44px;min-width:44px;padding:0;display:inline-flex;align-items:center;justify-content:center;font-size:18px}.back-btn span{display:none}.pos-navigation-drawer-shell{width:min(90vw,340px)}}
