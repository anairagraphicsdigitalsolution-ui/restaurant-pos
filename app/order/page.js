    ...
    <div className="anaira-pos">
      ...
      <style jsx global>{`
        *{box-sizing:border-box}
        ...
        .pos-navigation-drawer-layer{position:fixed;inset:0;width:100vw;height:100dvh;z-index:20000;pointer-events:none;touch-action:none;isolation:isolate}.pos-navigation-drawer-backdrop{position:absolute;inset:0;width:100%;height:100%;border:0;margin:0;padding:0;background:rgba(2,6,23,.58);backdrop-filter:blur(2px);cursor:pointer;pointer-events:auto;touch-action:manipulation;-webkit-tap-highlight-color:transparent}.pos-navigation-drawer-layer .pos-sidebar{pointer-events:auto;touch-action:pan-y;z-index:20001!important}.pos-menu-btn{position:relative;z-index:1001;touch-action:manipulation;-webkit-tap-highlight-color:transparent;height:44px;min-width:48px;display:inline-flex;align-items:center;justify-content:center;gap:7px;padding:0 13px;border:1px solid rgba(var(--primary-rgb),.25);border-radius:9px;background:rgba(var(--primary-rgb),.08);color:var(--primary);font-size:11px;font-weight:900;cursor:pointer;white-space:nowrap;user-select:none;-webkit-user-select:none} .pos-menu-btn:hover{background:rgba(var(--primary-rgb),.14)}
        .pos-menu-btn{position:relative;z-index:100;touch-action:manipulation;-webkit-tap-highlight-color:transparent;height:38px;display:inline-flex;align-items:center;justify-content:center;gap:7px;padding:0 12px;border:1px solid rgba(var(--primary-rgb),.25);border-radius:9px;background:rgba(var(--primary-rgb),.08);color:var(--primary);font-size:11px;font-weight:900;cursor:pointer;white-space:nowrap}.pos-menu-btn:hover{background:rgba(var(--primary-rgb),.14)}
