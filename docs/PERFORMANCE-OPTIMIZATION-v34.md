...
- Dashboard sales performance is aggregated once for the full current business day; no hourly chart series is generated.
...
- Existing Anaira-style order, delivery, billing, KOT and printer functionality is preserved.
